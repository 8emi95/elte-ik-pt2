 ...
 * @author Lúcia
 */
public class DataEntering extends JButton{
    ...
    private JLabel imageLabel=new JLabel("Adja meg a kép nevét (pl. titanic2.jpg): ");
    ...
    public ButtonGroup getGroupOriginal() {
    ...
    public DataEntering(JFrame frame, String information){
   ...
   //________________________________________________________________________ 
     ...
     imageField.setPreferredSize(d);
     imageField.setMinimumSize(d);
     imageField.setMaximumSize(d);
      ...
      this.setVisible(false);
       ...
       frame.getContentPane().add(imageLabel,BoxLayout.X_AXIS);
       frame.getContentPane().add(imageField,BoxLayout.Y_AXIS);
